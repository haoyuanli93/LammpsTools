"""
This file aims to create lammps script for LiOH solution.
"""
...
#############################################################################
def createSystemInfo(fileName, soluteMolarDensity, densityGCm3, boxSizeA, molFile,
                     molNameList, molarMassList,
                     randomSeed):
    """

    :param fileName:
    :param soluteMolarDensity:
    :param densityGCm3:
    :param boxSizeA:
    :param molFile:
    :param molNameList:
